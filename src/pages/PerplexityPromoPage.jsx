    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-blue-50 to-indigo-50 dark:from-gray-900 dark:via-purple-900/20 dark:to-blue-900/20">
      ...
      <div className="container mx-auto py-8 md:py-12 px-4 md:px-6 relative z-10">
        ...
        >
          ...
          <motion.h1
            className="text-2xl sm:text-3xl md:text-5xl lg:text-7xl font-extrabold text-foreground mb-4 md:mb-6 px-2"
            initial={{ scale: 0.8 }}
            animate={{ scale: 1 }}
          ...
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-muted-foreground max-w-xs sm:max-w-md md:max-w-2xl lg:max-w-4xl mx-auto mb-6 md:mb-8 leading-relaxed px-4">
            Experience the future of AI-powered learning with exclusive access to Perplexity AI Pro and the upcoming Comet Browser.
          </p>
